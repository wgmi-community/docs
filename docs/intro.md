# WGMI Guidebook (Jack 9-19-22 Edit)
...
1. Eligible Contributors have participated in 3+ completed Cohorts, executed a Funding Proposal with DAO Council, or have been nominated as a Guild Guide
2. Current DAO members can advocate for proposing new DAO member
3. Proposal to be posted in Community Forum as "Member Proposal." 
    - This gives the Community a chance to provide feedback, vote, and support in a more long-form post format
    - [View template]()
4. Proposal posted to DAOHaus 
...
5. Once confirmed, DAO shares are redeemable by the recipient address
...
1. Sub-guilds or Guild contributors identifying a need for a focused guild can come together to form a new guild when there is substantial support from the current Guild and DAO council. From here, you will need to start on the proposal process in `#dao-proposals.`

*<center>Substantial support is defined as support to fill the identified need, not out of negative intentions</center>*
...
*<center>Please see Governance Process for an overview on DAO proposals*</center>
